...
function ToolFallbackRoot({
  ...
  return (
    <Collapsible
      ...
      style={
        {
          "--animation-duration": `${ANIMATION_DURATION.toString()}ms`,
...
function ToolFallbackArguments({
  argsText,
  className,
  ...props
...
const ToolFallback = memo(
  ...
  Arguments: typeof ToolFallbackArguments;
...
ToolFallback.Arguments = ToolFallbackArguments;
