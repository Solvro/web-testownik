...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      ...
      className={cn(
        "bg-card border-border dark:border-accent text-muted-foreground inline-flex h-9 w-fit items-center justify-center rounded-lg border p-0.75",
        className,
      )}
      {...props}
    />
